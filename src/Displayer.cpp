...
float Displayer::u4_to_float(U4 number) {
	float ret;
...
long Displayer::u4_to_long(U4 high, U4 low) {
	long ret;
...
double Displayer::u4_to_double(U4 high, U4 low) {
	double ret;
	long limits = Displayer::u4_to_long(high, low);
...
void Displayer::display_field_by_index(Field_info f, vector <Cp_info> cp_vector, int index) {
	...
	cout << "\t\tFlags: " << Field_info::get_field_flags(f.access_flags) << endl;
	cout << "\t\tName: " << Displayer::dereference_index(cp_vector, f.name_index) << endl;
	cout << "\t\tDescription: " << Displayer::dereference_index(cp_vector, f.descriptor_index) << endl;
	cout << "\t\tAttributes count: " << (int)f.attributes_count << endl;
...
void Displayer::display_method_by_index(Method_info m, vector <Cp_info> cp_vector, int index) {
	...
	cout << "\t\tFlags: " << Method_info::get_method_flags(m.access_flags) << endl;
	cout << "\t\tName: " << Displayer::dereference_index(cp_vector, m.name_index) << endl;
	cout << "\t\tDescription: " << Displayer::dereference_index(cp_vector, m.descriptor_index) << endl;
	cout << "\t\tAttributes count: " << Displayer::dereference_index(cp_vector, m.descriptor_index) << endl;
